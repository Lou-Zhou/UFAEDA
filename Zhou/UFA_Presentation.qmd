...
=======
## Player Throwing Tendencies
>>>>>>> fe71431202c30e430a71bc8c41887b30c59bb539
>>>>>>> 83e0a99ea097838b96336a09a8cdb886677eda12
...
fluidPage(
    ...
    sidebarLayout(
      ...
      mainPanel(
          fluidRow(
        column(9, plotOutput("plot", height = "500px")),
        column(3, htmlOutput("text"))
      )
    )
  )
)
...
#Look at False, all
## Most failures occur on attempts near or in the end zone, risky passes only occur on scoring attempts
    
# Look at all, all, 80 - 100 away
## Deep throws are very rare, most prefer to throw a couple yards in front for a smaller gain rather than a risky attempt farther down the field

#Look at all, all, move in 20 yrd increments on the away slide
## Focus more on the middle until in scoring position, then attempts moreso to the flanks
    
# However, some players are more likely to go for deeper throws compared to others
    # Deep Thrower: jfelton
    # Conservative: jfroude
```

## Test

::: {.column width="100%"}
<iframe src="https://louzhou.shinyapps.io/ufa_endlocations/" width="100%" height="600px" style="border:none;">
...
-   3 variables: Quarter, Score Difference and Throw Distance.

-   Noticeable areas:

    -   In the 4th and tied, throw distance is high

    -   When team is up by 4 compared to down by 4
>>>>>>> 83e0a99ea097838b96336a09a8cdb886677eda12
:::
:::::
